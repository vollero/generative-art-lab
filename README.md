...
| 006 | [Modular Flow](artifacts/006-modular-flow/) | Iterated modular powers form cycles with transient basins flowing into them. | [`artifact-006-v1.0.0`](https://github.com/vollero/generative-art-lab/tree/artifact-006-v1.0.0/artifacts/006-modular-flow) |
